...
- [ ] Refer https://www.youtube.com/watch?v=j425CIWRfZ8
  to more hacking with css and work as desired.
...
** Define custom font
#+begin_src scss :tangle ./assets/scss/fonts/font-face.scss
  @font-face{
      font-family: 'impress';
...
#+end_src
** Font Variable
#+begin_src scss :tangle ./assets/scss/fonts/variables.scss
  $heading-font:  'impress', sans-serif;
  $body-font:     'code-ace', sans-serif;
  $code-font:     'code-op', monospace;
...
#+end_src
** Apply Fonts
#+begin_src scss :tangle ./assets/scss/fonts/heading.scss
  h1:before, h1:after {
      content: " ⩮ ";
      color: $h1-color;
  }
