...
As of new remake, the change is changed to==> [[https://gitlab.com/rmaguiar/hugo-theme-color-your-world][color-your-world]]

I hope its a soothing experience for you to read!

*** Ideas - TODO
**** DONE On Window manager                                          :post:
  CLOSED: [2025-01-02 Thu 19:46] SCHEDULED: <2023-03-30 Thu 13:01>
  :LOGBOOK:
  - State "DONE"       from "TODO"       [2025-01-02 Thu 19:46]
  :END:
...
**** DONE REVIEW Comprehensive post on Emacs android                 :post:
CLOSED: [2025-01-02 Thu 19:46] SCHEDULED: <2023-07-31 Mon>
:LOGBOOK:
- State "DONE"       from              [2025-01-02 Thu 19:46]
:END:
...
CLOSED: [2023-12-21 Thu 13:12]
:LOGBOOK:
- State "DONE"       from              [2023-12-21 Thu 13:12]
:END:
- Pros: emacs
- refer: https://github.com/tonyaldon/one.el
- Did have some limitations, I then tried *org-publish* (~ox-publish~), was almost convinced but had little too much work to get what I desired.
- The draft, initial setup is in =voyage= branch

**** TODO Write a post on using revealjs for presentation
:PROPERTIES:
:ID:       20250524T223510
:END:
- Note I used this for all my ppts
