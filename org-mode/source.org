...
** Wrap up on my Bioinformatics Masters Journey                    :masters:
:PROPERTIES:
...
** Embarking in Foss United                                      :work:foss:
:PROPERTIES:
...
** OBTF as Second Brain with Org mode                    :orgmode:emacs:pkm:
:PROPERTIES:
:EXPORT_FILE_NAME: obtf-org-mode
:EXPORT_DATE: [2025-09-06 Sat]
:END:
...
** Revamp the blogs                                               :snippets:
:PROPERTIES:
:EXPORT_FILE_NAME: revamp-blog-2026
:EXPORT_DATE: [2026-01-06 Tue]
:END:
